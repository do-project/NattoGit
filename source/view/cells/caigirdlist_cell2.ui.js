...
btnImg.on("touch","",300,function(){
	...
	var json = {path:this.source,title:_title.text,sales:_sales.text,price:_price.text,note:_title.tag,selected:flag,index:btnCon.tag,type:deviceone.param.type};
