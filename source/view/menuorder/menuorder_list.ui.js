...
var listviewbus = ui("do_ListView_bus");
...
function reserveList(){
	...
	var url = $U.url.SinglePointList+"?size="+size+"&index="+index+"&city="+city_node+"&area="+area+"&sort="+sort+"&node="+node+"&title="+title; // 请求的 URL
    if(location!=""){
...
listviewbus.on("touch", function(index) {
	...
	open.start("source://view/menuorder/menuorder_detail.ui",token.token,"menuorderstart");
});
